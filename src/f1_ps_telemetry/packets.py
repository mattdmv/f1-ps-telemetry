...
class WeatherForecastSample_V1(PackedLittleEndianStructure):
    ...
    _fields_ = [
        ('sessionType'            , ctypes.c_uint8),  # 0 = unknown, 1 = P1, 2 = P2, 3 = P3, 4 = Short P, 5 = Q1, 
                                                      # 6 = Q2, 7 = Q3, 8 = Short Q, 9 = OSQ, 10 = R, 11 = R2
                                                      # 12 = R3, 13 = Time Trial
        ('timeOffset'             , ctypes.c_uint8),  # Time in minutes the forecast is for
        ('weather'                , ctypes.c_uint8),  # Weather - 0 = clear, 1 = light cloud, 2 = overcast, 3 = light rain, 4 = heavy rain, 5 = storm 
...
class PacketSessionData_V1(PackedLittleEndianStructure):
    ...
    _fields_ = [
        ...
        ('weatherForecastSamples'   , WeatherForecastSample_V1 * 56),  # Array of weather forecast samples
        ...
        ('sessionLength'            , ctypes.c_uint8               )   # 0 = None, 2 = Very Short, 3 = Short, 4 = Medium
...
class LapData_V1(PackedLittleEndianStructure):
    ...
    _fields_ = [
        ...
        ('currentLapTimeInMS'         , ctypes.c_uint32),  # Current time around the lap in miliseconds
...
class SpeedTrap_V1(PackedLittleEndianStructure):
    _fields_ = [
        ...
        ('isOverallFastestInSession'  , ctypes.c_uint8),  # Overall fastest speed in session = 1, otherwise 0
        ('isDriverFastestInSession'   , ctypes.c_uint8),  # Fastest speed for driver in session = 1, otherwise 0
...
class Buttons_V1(PackedLittleEndianStructure):
    _fields_ = [
        ('buttonStatus', ctypes.c_uint32)  # Bit flags specifying which buttons are being pressed currently - see appendices
    ]
...
class PacketEventData_V1(PackedLittleEndianStructure):
    ...
    _fields_ = [
        ...
        ('eventDetails'    , EventDataDetails_V1)   # Event details - should be interpreted differently for each type
    ]
...
class PacketCarTelemetryData_V1(PackedLittleEndianStructure):
    ...
    _fields_ = [
        ...
        ('suggestedGear'                , ctypes.c_int8           )   # Suggested gear for the player (1-8), 0 if no gear suggested
    ]
...
class LapHistoryData_V1(PackedLittleEndianStructure):
    ...
    _fields_ = [
        ...
        ('lapValidBitFlags' , ctypes.c_uint8 )   # 0x01 bit set-lap valid, 0x02 bit set-sector 1 valid
